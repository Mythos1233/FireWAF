...
const firebaseConfig = {
  apiKey: "AIzaSyB12YLR6zvhplKFAxQw6eB58lDRXCqgfQc",
  authDomain: "projetowaf-fee78.firebaseapp.com",
  projectId: "projetowaf-fee78",
  storageBucket: "projetowaf-fee78.firebasestorage.app",
  messagingSenderId: "115921283531",
  appId: "1:115921283531:web:b1840365db39e40cabee4e",
  measurementId: "G-B64HHD0Z3S"
};
...
auth.onAuthStateChanged((user) => {
    ...
    if (user) {
        ...
        else if (currentPath.includes('pagina-segura.html')) {
